...
When('I enter partnerid, partner transaction id, customer id and subscription id', async function () {
     ...
     cy.get('#operations-GET-get_Subscription_V2__partnerId___partnerTransactionId___customerId___subscriptionId_ > div:nth-child(2) > div > div.opblock-section > div.parameters-container > div > table > tbody > tr:nth-child(2) > td.parameters-col_description > input[type=text]').type("qqw")
...
Then('I should get subscription status',{timeout: 60*2000},async function(){
    cy.wait(10000)
    cy.get('#operations-GET-get_Subscription_V2__partnerId___partnerTransactionId___customerId___subscriptionId_ > div:nth-child(2) > div > div.responses-wrapper > div.responses-inner > div > div > table > tbody > tr > td.response-col_status').eq(0).should('contain',"400")
})